...
5. Removed non-numeric column (Car_Name)
6. Split data into training and testing sets
7. Trained a Linear Regression model
8. Evaluated the model using MAE, MSE, and R2 score
9. Visualized actual vs predicted prices
10. Tested the model with sample input
